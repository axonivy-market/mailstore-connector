## Mailserver Setup for Mailstore Utility Testing

To facilitate testing of the mailstore utility, follow the instructions below to start the mailserver and configure your environment.
